...
public class MemberQnaAttachment {
	...
	public MemberQnaAttachment() {
		// TODO Auto-generated constructor stub
	}

	public MemberQnaAttachment(int attachmentNo, int qnaCode, String originalFileName, String reNamedFileName,
