                ...
                <div class="row">
                   <div class="col-md-4 mx-auto">
                      <div class="myform form ">
                         <form action="${path }/customer/memberSearchPwEnd.do" method="post" name="login">
                            <div class="form-group">
                               <input type="text" name="memberId"  class="form-control my-input" id="memberId" placeholder="아이디를 입력하세요.">
                            </div>
                            <div class="form-group">
